...
DROP TABLE IF EXISTS `llx_bootstrap`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_bootstrap` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `active` tinyint(4) NOT NULL DEFAULT '1',
  PRIMARY KEY (`rowid`),
  KEY `idx_bootstrap_label` (`fk_user_creat`),
  CONSTRAINT `fk_bootstrap_fk_user_creat` FOREIGN KEY (`fk_user_creat`) REFERENCES `llx_user` (`rowid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_bootstrap`
--

LOCK TABLES `llx_bootstrap` WRITE;
/*!40000 ALTER TABLE `llx_bootstrap` DISABLE KEYS */;
INSERT INTO `llx_bootstrap` VALUES (1,1,'2014-01-12 17:51:42','Mod&egrave;le ma&icirc;tre','C&#039;est le mod&egrave;le par d&eacute;faut','2014-01-12 18:51:42',1,NULL,1);
/*!40000 ALTER TABLE `llx_bootstrap` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llx_holiday_config` VALUES (1,'userGroup','1'),(2,'lastUpdate','20130301231231'),(3,'nbUser',''),(4,'delayForRequest','31'),(5,'AlertValidatorDelay','0'),(6,'AlertValidatorSolde','0'),(7,'nbHolidayDeducted','1'),(8,'nbHolidayEveryMonth','2.08334');
...
INSERT INTO `llx_holiday_users` VALUES (0,0),(1,74.00334000000001),(2,75.00024000000003),(3,75.00024000000003),(4,70.83356000000002),(5,2.08334),(6,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=108459 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `llx_opensurvey_sondage` VALUES ('m4467s2mtk6khmxc','m4467s2mtk6khmxci2ysw682','fdffdshfghfj jhgjgh','aaa@aaa.com','fdfds',0,'fdffds','2013-03-07 00:00:00','D+',1,1,'dolibarr','0000-00-00 00:00:00');
...
INSERT INTO `llx_paiement_facture` VALUES (1,1,1,0.02000000),(2,2,2,20.00000000),(3,3,2,10.00000000),(5,5,5,5.63000000),(6,6,6,5.98000000),(9,8,2,16.10000000),(10,8,8,10.00000000),(11,9,3,15.00000000),(12,9,9,11.96000000),(20,17,11,2.00000000),(21,18,12,-2.00000000),(22,19,10,-1.00000000),(23,19,12,-1.00000000),(24,20,9,1.00000000),(25,20,11,1.00000000),(26,21,12,-2.00000000),(28,23,55,1.00000000),(29,24,161,20.00000000),(30,25,210,10.00000000),(31,26,32,600.00000000),(32,26,148,5.00000000),(33,27,152,10.00000000),(34,27,157,20.00000000),(36,29,32,500.00000000),(37,30,32,400.00000000),(39,32,213,-400.00000000),(40,33,213,-300.00000000);
...
INSERT INTO `llx_project_task` VALUES (1,'1',1,1,0,'2010-07-11 15:15:55','2013-09-08 23:06:14','2010-07-11 12:00:00',NULL,NULL,'Work on module','',25920000,0,0,0,1,NULL,0,NULL,NULL,0,NULL),(2,'2',1,5,0,'2010-07-11 16:23:53','2013-09-08 23:06:14','2010-07-11 12:00:00','2011-07-14 12:00:00',NULL,'Heberger site RMLL','',0,0,0,0,1,NULL,0,NULL,NULL,0,NULL);
...
(1, '2010-07-08 13:20:11', '2012-12-12 16:54:10', 'admin', 0, NULL, NULL, NULL, 'admin', '21232f297a57a5a743894a0e4a801fc3', NULL, 'SuperAdminName', 'Firstname', '', NULL, '', '', '', 'bidon@destailleur.fr', '', 1, '', '', '', 1, 1, NULL, NULL, NULL, '', '2014-03-03 19:19:24', '2014-03-02 20:11:17', NULL, '', 1, '01.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL),
...
-- Dump completed on 2014-03-03 19:39:05
