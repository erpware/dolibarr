...
if (! empty($conf->global->ECM_AUTO_TREE_ENABLED))
{
	...
	if (! empty($conf->project->enabled))		{ $rowspan++; $sectionauto[]=array('level'=>1, 'module'=>'project', 'test'=>$conf->project->enabled, 'label'=>$langs->trans("Projects"), 'desc'=>$langs->trans("ECMDocsByProjects")); }
