...
/**
 * 		\file       htdocs/project/class/project.class.php
 * 		\ingroup    project
...
class Project extends CommonObject
{
    ...
    public $weekWorkLoad;			// Used to store workload details of a project
    public $weekWorkLoadPerTask;	// Used to store workload details of tasks of a project
    ...
    public function create($user, $notrigger = 0)
    {
        ...
        $sql = "INSERT INTO " . MAIN_DB_PREFIX . "project (";
        $sql.= "ref";
        $sql.= ", title";
        $sql.= ", description";
        $sql.= ", fk_soc";
        ...
        if ($resql)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX . "project");
            $ret = $this->id;
    ...
    public function update($user, $notrigger = 0)
    {
        ...
        if (dol_strlen(trim($this->ref)) > 0)
        {
            ...
            $sql = "UPDATE " . MAIN_DB_PREFIX . "project SET";
    ...
    public function delete($user, $notrigger = 0)
    {
        ...
        if (! $error)
        {
	        $sql = "DELETE FROM " . MAIN_DB_PREFIX . "project";
	        $sql.= " WHERE rowid=" . $this->id;
    ...
    public function setValid($user, $notrigger = 0)
    {
        ...
        if ($this->statut != 1)
        {
            ...
            $sql = "UPDATE " . MAIN_DB_PREFIX . "project";
            $sql.= " SET fk_statut = 1";
            $sql.= " WHERE rowid = " . $this->id;
    ...
    public function getNomUrl($withpicto = 0, $option = '', $addlabel = 0, $moreinpopup = '', $sep = ' - ', $notooltip = 0, $save_lastsearch_value = -1)
    {
        ...
        if ($option != 'nolink')
        {
            ...
            elseif ($option == 'task')
            {
                $url = DOL_URL_ROOT . '/project/tasks.php?id=' . $this->id;
            }
            else
            {
                $url = DOL_URL_ROOT . '/project/card.php?id=' . $this->id;
            }
	...
	public function info($id)
	{
	    ...
	    $sql.= ' FROM '.MAIN_DB_PREFIX.'project as c';
