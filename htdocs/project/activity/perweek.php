...
/**
 *	\file       htdocs/project/activity/perweek.php
 *	\ingroup    project
...
$projectsListId = $projectstatic->getProjectsAuthorizedForUser($usertoprocess, (empty($usertoprocess->id)?2:0), 1);  // Return all project i have permission on (assigned to me+public). I want my tasks and some of my task may be on a public project that is not my project
