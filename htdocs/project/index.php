 ...
 * Statistics
 */
include DOL_DOCUMENT_ROOT.'/project/graph_opportunities.inc.php';
...
if ( $resql )
{
	...
	while ($i < $num)
	{
		...
		if ($obj->socid) print '<a href="'.DOL_URL_ROOT.'/project/list.php?socid='.$obj->socid.'&search_status=1">'.$obj->nb.'</a>';
		else print '<a href="'.DOL_URL_ROOT.'/project/list.php?search_societe='.urlencode('^$').'&search_status=1">'.$obj->nb.'</a>';
		print '</td>';
		print "</tr>\n";
