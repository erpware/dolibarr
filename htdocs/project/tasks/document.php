...
/**
 *	\file       htdocs/project/tasks/document.php
 *	\ingroup    project
 *	\brief      Page de gestion des documents attachees a une tache d'un project
 */
...
if ($object->id > 0)
{
	...
	$linkback=GETPOST('withproject')?'<a href="'.DOL_URL_ROOT.'/project/tasks.php?id='.$projectstatic->id.'">'.$langs->trans("BackToList").'</a>':'';
