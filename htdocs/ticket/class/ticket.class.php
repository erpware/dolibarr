...
class Ticket extends CommonObject
{
    ...
    public $fields=array(
    	...
    	'fk_project' => array('type'=>'integer:Project:project/class/project.class.php', 'label'=>'Project', 'visible'=>-1, 'enabled'=>1, 'position'=>52, 'notnull'=>-1, 'index'=>1, 'help'=>"LinkToProject"),
