...
$arrayfields = array(
	...
	'p.title'=>array('label'=>"ProjectLabel", 'checked'=>0, 'enabled'=>(empty($conf->project->enabled) ? 0 : 1), 'position'=>40),
...
$sql .= " LEFT JOIN ".MAIN_DB_PREFIX."project as p ON p.rowid = f.fk_project";
