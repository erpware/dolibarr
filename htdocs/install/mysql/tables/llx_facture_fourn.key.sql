...
ALTER TABLE llx_facture_fourn ADD INDEX idx_facture_fourn_fk_project (fk_project);
...
ALTER TABLE llx_facture_fourn ADD CONSTRAINT fk_facture_fourn_fk_project         FOREIGN KEY (fk_project) REFERENCES llx_project (rowid);
