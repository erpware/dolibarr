...
ALTER TABLE llx_facture_rec ADD INDEX idx_facture_rec_fk_project (fk_project);
...
ALTER TABLE llx_facture_rec ADD CONSTRAINT fk_facture_rec_fk_project         FOREIGN KEY (fk_project) REFERENCES llx_project (rowid);
