...
ALTER TABLE llx_facture ADD INDEX idx_facture_fk_project (fk_project);
...
ALTER TABLE llx_facture ADD CONSTRAINT fk_facture_fk_project         FOREIGN KEY (fk_project) REFERENCES llx_project (rowid);
